...
for service in install-dotfiles.service setup-flatpak.service flatpak-user-update.service flatpak-user-update.timer hyprpolkitagent.service xdg-desktop-portal-hyprland.service dms.service; do
